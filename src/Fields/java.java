...
import ProyectoFileManager.Main;
...
public class java {
    ...
    public static void main(String[] args) {
        ...
        b.add(7, r);
        b.delete(7);
        //Object r3 = b.search(1);
        System.out.println(b.printBTree());
        int sum = "100".chars().reduce(0, Integer::sum);
        System.out.println(ps);
        // System.out.println(sum);

        // value = value.re("\\r++$", ""); //
//        System.out.println(value + " " + value.length());
//        String stripped = trim(value);
    }
